...
namespace SistemaGestionPacientes.Logica
{
    ...
    public class GestorPacientes
    {
        ...
        public List<Paciente> ConsultarPorNombre(string nombreBuscado)
        {
            return _listaPacientes.Where(p => p.Nombre.ToLower().Contains(nombreBuscado.ToLower())).ToList();
        }

        // OPERACIÓN: MODIFICACIÓN
        public void ModificarPaciente(string id, string nuevoNombre, int nuevaEdad, Sexo nuevoSexo, Estado nuevoEstado, DateTime nuevaFecha)
        {
